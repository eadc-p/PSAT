...
function doTheThing(ref) {
    ...
    if (qList[ques]['Question Image']) {
        ...
        console.log(qList[ques]['Question Image']);
    } else {
    ...
    /*
      ...
      */
    $('[for=optiona]').text(qList[ques]['Option a (Correct)']);
    $('[for=optionb]').text(qList[ques]['Option b']);
    $('[for=optionc]').text(qList[ques]['Option c']);
    $('[for=optiond]').text(qList[ques]['Option d']);
    if (ref === 0) {
        $('.back').addClass('disabled');
    } else {
